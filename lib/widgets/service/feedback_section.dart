...
class _FeedbackSectionState extends State<FeedbackSection> {
  ...
  Future<void> _submitFeedback() async {
    ...
    try {
      ...
      // Add feedback to the shared FeedbackService
      _feedbackService.addFeedback(
        userName: _nameController.text.trim(),
        serviceName: _messageController.text.trim(), // Use message as service context
        rating: 5, // Default rating for general feedback
        comment: _messageController.text.trim(),
        feedbackType: _selectedType,
        context: context, // Pass context for localization
      );
      
      debugPrint('✅ Feedback added to FeedbackService');
      debugPrint('   Total feedbacks now: ${_feedbackService.totalFeedbacks}');
